...
describe("source-repo-signals-lib parseGitHubRepoUrl", () => {
  ...
  it("parseGitHubRepoUrl variant 0", () => {
    const parsed = parseGitHubRepoUrl("https://github.com/anthropics/claude-code");
...
describe("source-repo-signals-lib collectSourceRepos", () => {
  ...
  it("collectSourceRepos agents 0", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/agents-org/demo-0" }]);
    expect(repos).toEqual(["agents-org/demo-0"]);
  });
  it("collectSourceRepos agents 1", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/agents-org/demo-1" }]);
    expect(repos).toEqual(["agents-org/demo-1"]);
  });
  it("collectSourceRepos agents 2", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/agents-org/demo-2" }]);
    expect(repos).toEqual(["agents-org/demo-2"]);
  });
  it("collectSourceRepos agents 3", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/agents-org/demo-3" }]);
    expect(repos).toEqual(["agents-org/demo-3"]);
  });
  it("collectSourceRepos agents 4", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/agents-org/demo-4" }]);
    expect(repos).toEqual(["agents-org/demo-4"]);
  });
  it("collectSourceRepos agents 5", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/agents-org/demo-5" }]);
    expect(repos).toEqual(["agents-org/demo-5"]);
  });
  it("collectSourceRepos agents 6", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/agents-org/demo-6" }]);
    expect(repos).toEqual(["agents-org/demo-6"]);
  });
  it("collectSourceRepos agents 7", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/agents-org/demo-7" }]);
    expect(repos).toEqual(["agents-org/demo-7"]);
  });
  it("collectSourceRepos mcp 0", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/mcp-org/demo-0" }]);
    expect(repos).toEqual(["mcp-org/demo-0"]);
  });
  it("collectSourceRepos mcp 1", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/mcp-org/demo-1" }]);
    expect(repos).toEqual(["mcp-org/demo-1"]);
  });
  it("collectSourceRepos mcp 2", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/mcp-org/demo-2" }]);
    expect(repos).toEqual(["mcp-org/demo-2"]);
  });
  it("collectSourceRepos mcp 3", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/mcp-org/demo-3" }]);
    expect(repos).toEqual(["mcp-org/demo-3"]);
  });
  it("collectSourceRepos mcp 4", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/mcp-org/demo-4" }]);
    expect(repos).toEqual(["mcp-org/demo-4"]);
  });
  it("collectSourceRepos mcp 5", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/mcp-org/demo-5" }]);
    expect(repos).toEqual(["mcp-org/demo-5"]);
  });
  it("collectSourceRepos mcp 6", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/mcp-org/demo-6" }]);
    expect(repos).toEqual(["mcp-org/demo-6"]);
  });
  it("collectSourceRepos mcp 7", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/mcp-org/demo-7" }]);
    expect(repos).toEqual(["mcp-org/demo-7"]);
  });
  it("collectSourceRepos tools 0", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/tools-org/demo-0" }]);
    expect(repos).toEqual(["tools-org/demo-0"]);
  });
  it("collectSourceRepos tools 1", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/tools-org/demo-1" }]);
    expect(repos).toEqual(["tools-org/demo-1"]);
  });
  it("collectSourceRepos tools 2", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/tools-org/demo-2" }]);
    expect(repos).toEqual(["tools-org/demo-2"]);
  });
  it("collectSourceRepos tools 3", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/tools-org/demo-3" }]);
    expect(repos).toEqual(["tools-org/demo-3"]);
  });
  it("collectSourceRepos tools 4", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/tools-org/demo-4" }]);
    expect(repos).toEqual(["tools-org/demo-4"]);
  });
  it("collectSourceRepos tools 5", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/tools-org/demo-5" }]);
    expect(repos).toEqual(["tools-org/demo-5"]);
  });
  it("collectSourceRepos tools 6", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/tools-org/demo-6" }]);
    expect(repos).toEqual(["tools-org/demo-6"]);
  });
  it("collectSourceRepos tools 7", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/tools-org/demo-7" }]);
    expect(repos).toEqual(["tools-org/demo-7"]);
  });
  it("collectSourceRepos skills 0", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/skills-org/demo-0" }]);
    expect(repos).toEqual(["skills-org/demo-0"]);
  });
  it("collectSourceRepos skills 1", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/skills-org/demo-1" }]);
    expect(repos).toEqual(["skills-org/demo-1"]);
  });
  it("collectSourceRepos skills 2", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/skills-org/demo-2" }]);
    expect(repos).toEqual(["skills-org/demo-2"]);
  });
  it("collectSourceRepos skills 3", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/skills-org/demo-3" }]);
    expect(repos).toEqual(["skills-org/demo-3"]);
  });
  it("collectSourceRepos skills 4", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/skills-org/demo-4" }]);
    expect(repos).toEqual(["skills-org/demo-4"]);
  });
  it("collectSourceRepos skills 5", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/skills-org/demo-5" }]);
    expect(repos).toEqual(["skills-org/demo-5"]);
  });
  it("collectSourceRepos skills 6", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/skills-org/demo-6" }]);
    expect(repos).toEqual(["skills-org/demo-6"]);
  });
  it("collectSourceRepos skills 7", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/skills-org/demo-7" }]);
    expect(repos).toEqual(["skills-org/demo-7"]);
  });
  it("collectSourceRepos rules 0", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/rules-org/demo-0" }]);
    expect(repos).toEqual(["rules-org/demo-0"]);
  });
  it("collectSourceRepos rules 1", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/rules-org/demo-1" }]);
    expect(repos).toEqual(["rules-org/demo-1"]);
  });
  it("collectSourceRepos rules 2", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/rules-org/demo-2" }]);
    expect(repos).toEqual(["rules-org/demo-2"]);
  });
  it("collectSourceRepos rules 3", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/rules-org/demo-3" }]);
    expect(repos).toEqual(["rules-org/demo-3"]);
  });
  it("collectSourceRepos rules 4", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/rules-org/demo-4" }]);
    expect(repos).toEqual(["rules-org/demo-4"]);
  });
  it("collectSourceRepos rules 5", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/rules-org/demo-5" }]);
    expect(repos).toEqual(["rules-org/demo-5"]);
  });
  it("collectSourceRepos rules 6", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/rules-org/demo-6" }]);
    expect(repos).toEqual(["rules-org/demo-6"]);
  });
  it("collectSourceRepos rules 7", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/rules-org/demo-7" }]);
    expect(repos).toEqual(["rules-org/demo-7"]);
  });
  it("collectSourceRepos commands 0", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/commands-org/demo-0" }]);
    expect(repos).toEqual(["commands-org/demo-0"]);
  });
  it("collectSourceRepos commands 1", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/commands-org/demo-1" }]);
    expect(repos).toEqual(["commands-org/demo-1"]);
  });
  it("collectSourceRepos commands 2", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/commands-org/demo-2" }]);
    expect(repos).toEqual(["commands-org/demo-2"]);
  });
  it("collectSourceRepos commands 3", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/commands-org/demo-3" }]);
    expect(repos).toEqual(["commands-org/demo-3"]);
  });
  it("collectSourceRepos commands 4", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/commands-org/demo-4" }]);
    expect(repos).toEqual(["commands-org/demo-4"]);
  });
  it("collectSourceRepos commands 5", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/commands-org/demo-5" }]);
    expect(repos).toEqual(["commands-org/demo-5"]);
  });
  it("collectSourceRepos commands 6", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/commands-org/demo-6" }]);
    expect(repos).toEqual(["commands-org/demo-6"]);
  });
  it("collectSourceRepos commands 7", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/commands-org/demo-7" }]);
    expect(repos).toEqual(["commands-org/demo-7"]);
  });
  it("collectSourceRepos hooks 0", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/hooks-org/demo-0" }]);
    expect(repos).toEqual(["hooks-org/demo-0"]);
  });
  it("collectSourceRepos hooks 1", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/hooks-org/demo-1" }]);
    expect(repos).toEqual(["hooks-org/demo-1"]);
  });
  it("collectSourceRepos hooks 2", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/hooks-org/demo-2" }]);
    expect(repos).toEqual(["hooks-org/demo-2"]);
  });
  it("collectSourceRepos hooks 3", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/hooks-org/demo-3" }]);
    expect(repos).toEqual(["hooks-org/demo-3"]);
  });
  it("collectSourceRepos hooks 4", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/hooks-org/demo-4" }]);
    expect(repos).toEqual(["hooks-org/demo-4"]);
  });
  it("collectSourceRepos hooks 5", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/hooks-org/demo-5" }]);
    expect(repos).toEqual(["hooks-org/demo-5"]);
  });
  it("collectSourceRepos hooks 6", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/hooks-org/demo-6" }]);
    expect(repos).toEqual(["hooks-org/demo-6"]);
  });
  it("collectSourceRepos hooks 7", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/hooks-org/demo-7" }]);
    expect(repos).toEqual(["hooks-org/demo-7"]);
  });
  it("collectSourceRepos guides 0", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/guides-org/demo-0" }]);
    expect(repos).toEqual(["guides-org/demo-0"]);
  });
  it("collectSourceRepos guides 1", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/guides-org/demo-1" }]);
    expect(repos).toEqual(["guides-org/demo-1"]);
  });
  it("collectSourceRepos guides 2", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/guides-org/demo-2" }]);
    expect(repos).toEqual(["guides-org/demo-2"]);
  });
  it("collectSourceRepos guides 3", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/guides-org/demo-3" }]);
    expect(repos).toEqual(["guides-org/demo-3"]);
  });
  it("collectSourceRepos guides 4", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/guides-org/demo-4" }]);
    expect(repos).toEqual(["guides-org/demo-4"]);
  });
  it("collectSourceRepos guides 5", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/guides-org/demo-5" }]);
    expect(repos).toEqual(["guides-org/demo-5"]);
  });
  it("collectSourceRepos guides 6", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/guides-org/demo-6" }]);
    expect(repos).toEqual(["guides-org/demo-6"]);
  });
  it("collectSourceRepos guides 7", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/guides-org/demo-7" }]);
    expect(repos).toEqual(["guides-org/demo-7"]);
  });
  it("collectSourceRepos collections 0", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/collections-org/demo-0" }]);
    expect(repos).toEqual(["collections-org/demo-0"]);
  });
  it("collectSourceRepos collections 1", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/collections-org/demo-1" }]);
    expect(repos).toEqual(["collections-org/demo-1"]);
  });
  it("collectSourceRepos collections 2", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/collections-org/demo-2" }]);
    expect(repos).toEqual(["collections-org/demo-2"]);
  });
  it("collectSourceRepos collections 3", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/collections-org/demo-3" }]);
    expect(repos).toEqual(["collections-org/demo-3"]);
  });
  it("collectSourceRepos collections 4", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/collections-org/demo-4" }]);
    expect(repos).toEqual(["collections-org/demo-4"]);
  });
  it("collectSourceRepos collections 5", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/collections-org/demo-5" }]);
    expect(repos).toEqual(["collections-org/demo-5"]);
  });
  it("collectSourceRepos collections 6", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/collections-org/demo-6" }]);
    expect(repos).toEqual(["collections-org/demo-6"]);
  });
  it("collectSourceRepos collections 7", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/collections-org/demo-7" }]);
    expect(repos).toEqual(["collections-org/demo-7"]);
  });
  it("collectSourceRepos statuslines 0", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/statuslines-org/demo-0" }]);
    expect(repos).toEqual(["statuslines-org/demo-0"]);
  });
  it("collectSourceRepos statuslines 1", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/statuslines-org/demo-1" }]);
    expect(repos).toEqual(["statuslines-org/demo-1"]);
  });
  it("collectSourceRepos statuslines 2", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/statuslines-org/demo-2" }]);
    expect(repos).toEqual(["statuslines-org/demo-2"]);
  });
  it("collectSourceRepos statuslines 3", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/statuslines-org/demo-3" }]);
    expect(repos).toEqual(["statuslines-org/demo-3"]);
  });
  it("collectSourceRepos statuslines 4", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/statuslines-org/demo-4" }]);
    expect(repos).toEqual(["statuslines-org/demo-4"]);
  });
  it("collectSourceRepos statuslines 5", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/statuslines-org/demo-5" }]);
    expect(repos).toEqual(["statuslines-org/demo-5"]);
  });
  it("collectSourceRepos statuslines 6", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/statuslines-org/demo-6" }]);
    expect(repos).toEqual(["statuslines-org/demo-6"]);
  });
  it("collectSourceRepos statuslines 7", () => {
    const repos = collectSourceRepos([{ repoUrl: "https://github.com/statuslines-org/demo-7" }]);
...
describe("source-repo-signals-lib normalizeSourceRepoSignalRow", () => {
  it("normalizes database row shape", () => {
    expect(normalizeSourceRepoSignalRow({
  ...
  it("normalizeSourceRepoSignalRow matrix 0", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-0/repo-0", stars: 0, forks: 0, repo_updated_at: "2026-06-01", fetched_at: "2026-06-02", status: "error", last_error: "boom",
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 1", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-1/repo-1", stars: 1, forks: 1, repo_updated_at: "2026-06-02", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 2", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-2/repo-2", stars: 2, forks: 2, repo_updated_at: "2026-06-03", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 3", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-3/repo-3", stars: 3, forks: 3, repo_updated_at: "2026-06-04", fetched_at: "2026-06-02", status: "error", last_error: "boom",
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 4", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-4/repo-4", stars: 4, forks: 4, repo_updated_at: "2026-06-05", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 5", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-5/repo-5", stars: 5, forks: 0, repo_updated_at: "2026-06-06", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 6", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-6/repo-6", stars: 6, forks: 1, repo_updated_at: "2026-06-07", fetched_at: "2026-06-02", status: "error", last_error: "boom",
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 7", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-7/repo-7", stars: 7, forks: 2, repo_updated_at: "2026-06-08", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 8", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-8/repo-8", stars: 8, forks: 3, repo_updated_at: "2026-06-09", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 9", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-9/repo-9", stars: 9, forks: 4, repo_updated_at: "2026-06-10", fetched_at: "2026-06-02", status: "error", last_error: "boom",
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 10", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-10/repo-10", stars: 10, forks: 0, repo_updated_at: "2026-06-11", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 11", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-11/repo-11", stars: 11, forks: 1, repo_updated_at: "2026-06-12", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 12", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-12/repo-12", stars: 12, forks: 2, repo_updated_at: "2026-06-13", fetched_at: "2026-06-02", status: "error", last_error: "boom",
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 13", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-13/repo-13", stars: 13, forks: 3, repo_updated_at: "2026-06-14", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 14", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-14/repo-14", stars: 14, forks: 4, repo_updated_at: "2026-06-15", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 15", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-15/repo-15", stars: 15, forks: 0, repo_updated_at: "2026-06-16", fetched_at: "2026-06-02", status: "error", last_error: "boom",
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 16", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-16/repo-16", stars: 16, forks: 1, repo_updated_at: "2026-06-17", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 17", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-17/repo-17", stars: 17, forks: 2, repo_updated_at: "2026-06-18", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 18", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-18/repo-18", stars: 18, forks: 3, repo_updated_at: "2026-06-19", fetched_at: "2026-06-02", status: "error", last_error: "boom",
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 19", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-19/repo-19", stars: 19, forks: 4, repo_updated_at: "2026-06-20", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 20", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-20/repo-20", stars: 20, forks: 0, repo_updated_at: "2026-06-21", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 21", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-21/repo-21", stars: 21, forks: 1, repo_updated_at: "2026-06-22", fetched_at: "2026-06-02", status: "error", last_error: "boom",
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 22", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-22/repo-22", stars: 22, forks: 2, repo_updated_at: "2026-06-23", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 23", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-23/repo-23", stars: 23, forks: 3, repo_updated_at: "2026-06-24", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 24", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-24/repo-24", stars: 24, forks: 4, repo_updated_at: "2026-06-25", fetched_at: "2026-06-02", status: "error", last_error: "boom",
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 25", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-25/repo-25", stars: 25, forks: 0, repo_updated_at: "2026-06-26", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 26", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-26/repo-26", stars: 26, forks: 1, repo_updated_at: "2026-06-27", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 27", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-27/repo-27", stars: 27, forks: 2, repo_updated_at: "2026-06-28", fetched_at: "2026-06-02", status: "error", last_error: "boom",
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 28", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-28/repo-28", stars: 28, forks: 3, repo_updated_at: "2026-06-01", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 29", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-29/repo-29", stars: 29, forks: 4, repo_updated_at: "2026-06-02", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 30", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-30/repo-30", stars: 30, forks: 0, repo_updated_at: "2026-06-03", fetched_at: "2026-06-02", status: "error", last_error: "boom",
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 31", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-31/repo-31", stars: 31, forks: 1, repo_updated_at: "2026-06-04", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 32", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-32/repo-32", stars: 32, forks: 2, repo_updated_at: "2026-06-05", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 33", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-33/repo-33", stars: 33, forks: 3, repo_updated_at: "2026-06-06", fetched_at: "2026-06-02", status: "error", last_error: "boom",
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 34", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-34/repo-34", stars: 34, forks: 4, repo_updated_at: "2026-06-07", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 35", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-35/repo-35", stars: 35, forks: 0, repo_updated_at: "2026-06-08", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 36", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-36/repo-36", stars: 36, forks: 1, repo_updated_at: "2026-06-09", fetched_at: "2026-06-02", status: "error", last_error: "boom",
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 37", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-37/repo-37", stars: 37, forks: 2, repo_updated_at: "2026-06-10", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 38", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-38/repo-38", stars: 38, forks: 3, repo_updated_at: "2026-06-11", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 39", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-39/repo-39", stars: 39, forks: 4, repo_updated_at: "2026-06-12", fetched_at: "2026-06-02", status: "error", last_error: "boom",
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 40", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-40/repo-40", stars: 40, forks: 0, repo_updated_at: "2026-06-13", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 41", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-41/repo-41", stars: 41, forks: 1, repo_updated_at: "2026-06-14", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 42", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-42/repo-42", stars: 42, forks: 2, repo_updated_at: "2026-06-15", fetched_at: "2026-06-02", status: "error", last_error: "boom",
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 43", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-43/repo-43", stars: 43, forks: 3, repo_updated_at: "2026-06-16", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 44", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-44/repo-44", stars: 44, forks: 4, repo_updated_at: "2026-06-17", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 45", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-45/repo-45", stars: 45, forks: 0, repo_updated_at: "2026-06-18", fetched_at: "2026-06-02", status: "error", last_error: "boom",
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 46", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-46/repo-46", stars: 46, forks: 1, repo_updated_at: "2026-06-19", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 47", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-47/repo-47", stars: 47, forks: 2, repo_updated_at: "2026-06-20", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 48", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-48/repo-48", stars: 48, forks: 3, repo_updated_at: "2026-06-21", fetched_at: "2026-06-02", status: "error", last_error: "boom",
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 49", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-49/repo-49", stars: 49, forks: 4, repo_updated_at: "2026-06-22", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 50", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-50/repo-50", stars: 50, forks: 0, repo_updated_at: "2026-06-23", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 51", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-51/repo-51", stars: 51, forks: 1, repo_updated_at: "2026-06-24", fetched_at: "2026-06-02", status: "error", last_error: "boom",
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 52", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-52/repo-52", stars: 52, forks: 2, repo_updated_at: "2026-06-25", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 53", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-53/repo-53", stars: 53, forks: 3, repo_updated_at: "2026-06-26", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 54", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-54/repo-54", stars: 54, forks: 4, repo_updated_at: "2026-06-27", fetched_at: "2026-06-02", status: "error", last_error: "boom",
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 55", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-55/repo-55", stars: 55, forks: 0, repo_updated_at: "2026-06-28", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 56", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-56/repo-56", stars: 56, forks: 1, repo_updated_at: "2026-06-01", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 57", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-57/repo-57", stars: 57, forks: 2, repo_updated_at: "2026-06-02", fetched_at: "2026-06-02", status: "error", last_error: "boom",
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 58", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-58/repo-58", stars: 58, forks: 3, repo_updated_at: "2026-06-03", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 59", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-59/repo-59", stars: 59, forks: 4, repo_updated_at: "2026-06-04", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 60", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-60/repo-60", stars: 60, forks: 0, repo_updated_at: "2026-06-05", fetched_at: "2026-06-02", status: "error", last_error: "boom",
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 61", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-61/repo-61", stars: 61, forks: 1, repo_updated_at: "2026-06-06", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 62", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-62/repo-62", stars: 62, forks: 2, repo_updated_at: "2026-06-07", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 63", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-63/repo-63", stars: 63, forks: 3, repo_updated_at: "2026-06-08", fetched_at: "2026-06-02", status: "error", last_error: "boom",
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 64", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-64/repo-64", stars: 64, forks: 4, repo_updated_at: "2026-06-09", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 65", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-65/repo-65", stars: 65, forks: 0, repo_updated_at: "2026-06-10", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 66", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-66/repo-66", stars: 66, forks: 1, repo_updated_at: "2026-06-11", fetched_at: "2026-06-02", status: "error", last_error: "boom",
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 67", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-67/repo-67", stars: 67, forks: 2, repo_updated_at: "2026-06-12", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 68", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-68/repo-68", stars: 68, forks: 3, repo_updated_at: "2026-06-13", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 69", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-69/repo-69", stars: 69, forks: 4, repo_updated_at: "2026-06-14", fetched_at: "2026-06-02", status: "error", last_error: "boom",
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 70", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-70/repo-70", stars: 70, forks: 0, repo_updated_at: "2026-06-15", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 71", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-71/repo-71", stars: 71, forks: 1, repo_updated_at: "2026-06-16", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 72", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-72/repo-72", stars: 72, forks: 2, repo_updated_at: "2026-06-17", fetched_at: "2026-06-02", status: "error", last_error: "boom",
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 73", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-73/repo-73", stars: 73, forks: 3, repo_updated_at: "2026-06-18", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 74", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-74/repo-74", stars: 74, forks: 4, repo_updated_at: "2026-06-19", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 75", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-75/repo-75", stars: 75, forks: 0, repo_updated_at: "2026-06-20", fetched_at: "2026-06-02", status: "error", last_error: "boom",
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 76", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-76/repo-76", stars: 76, forks: 1, repo_updated_at: "2026-06-21", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 77", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-77/repo-77", stars: 77, forks: 2, repo_updated_at: "2026-06-22", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 78", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-78/repo-78", stars: 78, forks: 3, repo_updated_at: "2026-06-23", fetched_at: "2026-06-02", status: "error", last_error: "boom",
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 79", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-79/repo-79", stars: 79, forks: 4, repo_updated_at: "2026-06-24", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 80", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-80/repo-80", stars: 80, forks: 0, repo_updated_at: "2026-06-25", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 81", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-81/repo-81", stars: 81, forks: 1, repo_updated_at: "2026-06-26", fetched_at: "2026-06-02", status: "error", last_error: "boom",
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 82", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-82/repo-82", stars: 82, forks: 2, repo_updated_at: "2026-06-27", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 83", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-83/repo-83", stars: 83, forks: 3, repo_updated_at: "2026-06-28", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 84", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-84/repo-84", stars: 84, forks: 4, repo_updated_at: "2026-06-01", fetched_at: "2026-06-02", status: "error", last_error: "boom",
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 85", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-85/repo-85", stars: 85, forks: 0, repo_updated_at: "2026-06-02", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 86", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-86/repo-86", stars: 86, forks: 1, repo_updated_at: "2026-06-03", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 87", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-87/repo-87", stars: 87, forks: 2, repo_updated_at: "2026-06-04", fetched_at: "2026-06-02", status: "error", last_error: "boom",
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 88", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-88/repo-88", stars: 88, forks: 3, repo_updated_at: "2026-06-05", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 89", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-89/repo-89", stars: 89, forks: 4, repo_updated_at: "2026-06-06", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 90", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-90/repo-90", stars: 90, forks: 0, repo_updated_at: "2026-06-07", fetched_at: "2026-06-02", status: "error", last_error: "boom",
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 91", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-91/repo-91", stars: 91, forks: 1, repo_updated_at: "2026-06-08", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 92", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-92/repo-92", stars: 92, forks: 2, repo_updated_at: "2026-06-09", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 93", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-93/repo-93", stars: 93, forks: 3, repo_updated_at: "2026-06-10", fetched_at: "2026-06-02", status: "error", last_error: "boom",
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 94", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-94/repo-94", stars: 94, forks: 4, repo_updated_at: "2026-06-11", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 95", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-95/repo-95", stars: 95, forks: 0, repo_updated_at: "2026-06-12", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 96", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-96/repo-96", stars: 96, forks: 1, repo_updated_at: "2026-06-13", fetched_at: "2026-06-02", status: "error", last_error: "boom",
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 97", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-97/repo-97", stars: 97, forks: 2, repo_updated_at: "2026-06-14", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 98", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-98/repo-98", stars: 98, forks: 3, repo_updated_at: "2026-06-15", fetched_at: "2026-06-02", status: "ok", last_error: null,
    });
  ...
  it("normalizeSourceRepoSignalRow matrix 99", () => {
    const signal = normalizeSourceRepoSignalRow({
      repo: "org-99/repo-99", stars: 99, forks: 4, repo_updated_at: "2026-06-16", fetched_at: "2026-06-02", status: "error", last_error: "boom",
    });
...
describe("source-repo-signals-lib applySourceRepoSignal", () => {
  ...
  it("applySourceRepoSignal matrix 0", () => {
    const entry = { repoUrl: "https://github.com/org-0/repo-0", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-0/repo-0", { repo: "org-0/repo-0", stars: 0, forks: 0, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
  ...
  it("applySourceRepoSignal matrix 1", () => {
    const entry = { repoUrl: "https://github.com/org-1/repo-1", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-1/repo-1", { repo: "org-1/repo-1", stars: 10, forks: 1, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(10);
    expect(applied.repoStats?.stars).toBe(10);
  });
  it("applySourceRepoSignal matrix 2", () => {
    const entry = { repoUrl: "https://github.com/org-2/repo-2", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-2/repo-2", { repo: "org-2/repo-2", stars: 20, forks: 2, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(20);
    expect(applied.repoStats?.stars).toBe(20);
  });
  it("applySourceRepoSignal matrix 3", () => {
    const entry = { repoUrl: "https://github.com/org-3/repo-3", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-3/repo-3", { repo: "org-3/repo-3", stars: 30, forks: 3, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(30);
    expect(applied.repoStats?.stars).toBe(30);
  });
  it("applySourceRepoSignal matrix 4", () => {
    const entry = { repoUrl: "https://github.com/org-4/repo-4", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-4/repo-4", { repo: "org-4/repo-4", stars: 40, forks: 4, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(40);
    expect(applied.repoStats?.stars).toBe(40);
  });
  it("applySourceRepoSignal matrix 5", () => {
    const entry = { repoUrl: "https://github.com/org-5/repo-5", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-5/repo-5", { repo: "org-5/repo-5", stars: 50, forks: 5, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(50);
    expect(applied.repoStats?.stars).toBe(50);
  });
  it("applySourceRepoSignal matrix 6", () => {
    const entry = { repoUrl: "https://github.com/org-6/repo-6", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-6/repo-6", { repo: "org-6/repo-6", stars: 60, forks: 6, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(60);
    expect(applied.repoStats?.stars).toBe(60);
  });
  it("applySourceRepoSignal matrix 7", () => {
    const entry = { repoUrl: "https://github.com/org-7/repo-7", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-7/repo-7", { repo: "org-7/repo-7", stars: 70, forks: 7, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(70);
    expect(applied.repoStats?.stars).toBe(70);
  });
  it("applySourceRepoSignal matrix 8", () => {
    const entry = { repoUrl: "https://github.com/org-8/repo-8", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-8/repo-8", { repo: "org-8/repo-8", stars: 80, forks: 8, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(80);
    expect(applied.repoStats?.stars).toBe(80);
  });
  it("applySourceRepoSignal matrix 9", () => {
    const entry = { repoUrl: "https://github.com/org-9/repo-9", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-9/repo-9", { repo: "org-9/repo-9", stars: 90, forks: 9, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(90);
    expect(applied.repoStats?.stars).toBe(90);
  });
  it("applySourceRepoSignal matrix 10", () => {
    const entry = { repoUrl: "https://github.com/org-10/repo-10", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-10/repo-10", { repo: "org-10/repo-10", stars: 100, forks: 10, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(100);
    expect(applied.repoStats?.stars).toBe(100);
  });
  it("applySourceRepoSignal matrix 11", () => {
    const entry = { repoUrl: "https://github.com/org-11/repo-11", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-11/repo-11", { repo: "org-11/repo-11", stars: 110, forks: 11, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(110);
    expect(applied.repoStats?.stars).toBe(110);
  });
  it("applySourceRepoSignal matrix 12", () => {
    const entry = { repoUrl: "https://github.com/org-12/repo-12", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-12/repo-12", { repo: "org-12/repo-12", stars: 120, forks: 12, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(120);
    expect(applied.repoStats?.stars).toBe(120);
  });
  it("applySourceRepoSignal matrix 13", () => {
    const entry = { repoUrl: "https://github.com/org-13/repo-13", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-13/repo-13", { repo: "org-13/repo-13", stars: 130, forks: 13, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(130);
    expect(applied.repoStats?.stars).toBe(130);
  });
  it("applySourceRepoSignal matrix 14", () => {
    const entry = { repoUrl: "https://github.com/org-14/repo-14", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-14/repo-14", { repo: "org-14/repo-14", stars: 140, forks: 14, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(140);
    expect(applied.repoStats?.stars).toBe(140);
  });
  it("applySourceRepoSignal matrix 15", () => {
    const entry = { repoUrl: "https://github.com/org-15/repo-15", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-15/repo-15", { repo: "org-15/repo-15", stars: 150, forks: 15, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(150);
    expect(applied.repoStats?.stars).toBe(150);
  });
  it("applySourceRepoSignal matrix 16", () => {
    const entry = { repoUrl: "https://github.com/org-16/repo-16", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-16/repo-16", { repo: "org-16/repo-16", stars: 160, forks: 16, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(160);
    expect(applied.repoStats?.stars).toBe(160);
  });
  it("applySourceRepoSignal matrix 17", () => {
    const entry = { repoUrl: "https://github.com/org-17/repo-17", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-17/repo-17", { repo: "org-17/repo-17", stars: 170, forks: 17, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(170);
    expect(applied.repoStats?.stars).toBe(170);
  });
  it("applySourceRepoSignal matrix 18", () => {
    const entry = { repoUrl: "https://github.com/org-18/repo-18", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-18/repo-18", { repo: "org-18/repo-18", stars: 180, forks: 18, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(180);
    expect(applied.repoStats?.stars).toBe(180);
  });
  it("applySourceRepoSignal matrix 19", () => {
    const entry = { repoUrl: "https://github.com/org-19/repo-19", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-19/repo-19", { repo: "org-19/repo-19", stars: 190, forks: 19, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(190);
    expect(applied.repoStats?.stars).toBe(190);
  });
  it("applySourceRepoSignal matrix 20", () => {
    const entry = { repoUrl: "https://github.com/org-20/repo-20", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-20/repo-20", { repo: "org-20/repo-20", stars: 200, forks: 20, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(200);
    expect(applied.repoStats?.stars).toBe(200);
  });
  it("applySourceRepoSignal matrix 21", () => {
    const entry = { repoUrl: "https://github.com/org-21/repo-21", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-21/repo-21", { repo: "org-21/repo-21", stars: 210, forks: 21, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(210);
    expect(applied.repoStats?.stars).toBe(210);
  });
  it("applySourceRepoSignal matrix 22", () => {
    const entry = { repoUrl: "https://github.com/org-22/repo-22", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-22/repo-22", { repo: "org-22/repo-22", stars: 220, forks: 22, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(220);
    expect(applied.repoStats?.stars).toBe(220);
  });
  it("applySourceRepoSignal matrix 23", () => {
    const entry = { repoUrl: "https://github.com/org-23/repo-23", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-23/repo-23", { repo: "org-23/repo-23", stars: 230, forks: 23, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(230);
    expect(applied.repoStats?.stars).toBe(230);
  });
  it("applySourceRepoSignal matrix 24", () => {
    const entry = { repoUrl: "https://github.com/org-24/repo-24", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-24/repo-24", { repo: "org-24/repo-24", stars: 240, forks: 24, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(240);
    expect(applied.repoStats?.stars).toBe(240);
  });
  it("applySourceRepoSignal matrix 25", () => {
    const entry = { repoUrl: "https://github.com/org-25/repo-25", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-25/repo-25", { repo: "org-25/repo-25", stars: 250, forks: 25, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(250);
    expect(applied.repoStats?.stars).toBe(250);
  });
  it("applySourceRepoSignal matrix 26", () => {
    const entry = { repoUrl: "https://github.com/org-26/repo-26", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-26/repo-26", { repo: "org-26/repo-26", stars: 260, forks: 26, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(260);
    expect(applied.repoStats?.stars).toBe(260);
  });
  it("applySourceRepoSignal matrix 27", () => {
    const entry = { repoUrl: "https://github.com/org-27/repo-27", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-27/repo-27", { repo: "org-27/repo-27", stars: 270, forks: 27, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(270);
    expect(applied.repoStats?.stars).toBe(270);
  });
  it("applySourceRepoSignal matrix 28", () => {
    const entry = { repoUrl: "https://github.com/org-28/repo-28", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-28/repo-28", { repo: "org-28/repo-28", stars: 280, forks: 28, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(280);
    expect(applied.repoStats?.stars).toBe(280);
  });
  it("applySourceRepoSignal matrix 29", () => {
    const entry = { repoUrl: "https://github.com/org-29/repo-29", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-29/repo-29", { repo: "org-29/repo-29", stars: 290, forks: 29, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(290);
    expect(applied.repoStats?.stars).toBe(290);
  });
  it("applySourceRepoSignal matrix 30", () => {
    const entry = { repoUrl: "https://github.com/org-30/repo-30", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-30/repo-30", { repo: "org-30/repo-30", stars: 300, forks: 30, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(300);
    expect(applied.repoStats?.stars).toBe(300);
  });
  it("applySourceRepoSignal matrix 31", () => {
    const entry = { repoUrl: "https://github.com/org-31/repo-31", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-31/repo-31", { repo: "org-31/repo-31", stars: 310, forks: 31, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(310);
    expect(applied.repoStats?.stars).toBe(310);
  });
  it("applySourceRepoSignal matrix 32", () => {
    const entry = { repoUrl: "https://github.com/org-32/repo-32", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-32/repo-32", { repo: "org-32/repo-32", stars: 320, forks: 32, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(320);
    expect(applied.repoStats?.stars).toBe(320);
  });
  it("applySourceRepoSignal matrix 33", () => {
    const entry = { repoUrl: "https://github.com/org-33/repo-33", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-33/repo-33", { repo: "org-33/repo-33", stars: 330, forks: 33, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(330);
    expect(applied.repoStats?.stars).toBe(330);
  });
  it("applySourceRepoSignal matrix 34", () => {
    const entry = { repoUrl: "https://github.com/org-34/repo-34", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-34/repo-34", { repo: "org-34/repo-34", stars: 340, forks: 34, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(340);
    expect(applied.repoStats?.stars).toBe(340);
  });
  it("applySourceRepoSignal matrix 35", () => {
    const entry = { repoUrl: "https://github.com/org-35/repo-35", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-35/repo-35", { repo: "org-35/repo-35", stars: 350, forks: 35, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(350);
    expect(applied.repoStats?.stars).toBe(350);
  });
  it("applySourceRepoSignal matrix 36", () => {
    const entry = { repoUrl: "https://github.com/org-36/repo-36", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-36/repo-36", { repo: "org-36/repo-36", stars: 360, forks: 36, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(360);
    expect(applied.repoStats?.stars).toBe(360);
  });
  it("applySourceRepoSignal matrix 37", () => {
    const entry = { repoUrl: "https://github.com/org-37/repo-37", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-37/repo-37", { repo: "org-37/repo-37", stars: 370, forks: 37, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(370);
    expect(applied.repoStats?.stars).toBe(370);
  });
  it("applySourceRepoSignal matrix 38", () => {
    const entry = { repoUrl: "https://github.com/org-38/repo-38", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-38/repo-38", { repo: "org-38/repo-38", stars: 380, forks: 38, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(380);
    expect(applied.repoStats?.stars).toBe(380);
  });
  it("applySourceRepoSignal matrix 39", () => {
    const entry = { repoUrl: "https://github.com/org-39/repo-39", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-39/repo-39", { repo: "org-39/repo-39", stars: 390, forks: 39, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(390);
    expect(applied.repoStats?.stars).toBe(390);
  });
  it("applySourceRepoSignal matrix 40", () => {
    const entry = { repoUrl: "https://github.com/org-40/repo-40", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-40/repo-40", { repo: "org-40/repo-40", stars: 400, forks: 40, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(400);
    expect(applied.repoStats?.stars).toBe(400);
  });
  it("applySourceRepoSignal matrix 41", () => {
    const entry = { repoUrl: "https://github.com/org-41/repo-41", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-41/repo-41", { repo: "org-41/repo-41", stars: 410, forks: 41, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(410);
    expect(applied.repoStats?.stars).toBe(410);
  });
  it("applySourceRepoSignal matrix 42", () => {
    const entry = { repoUrl: "https://github.com/org-42/repo-42", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-42/repo-42", { repo: "org-42/repo-42", stars: 420, forks: 42, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(420);
    expect(applied.repoStats?.stars).toBe(420);
  });
  it("applySourceRepoSignal matrix 43", () => {
    const entry = { repoUrl: "https://github.com/org-43/repo-43", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-43/repo-43", { repo: "org-43/repo-43", stars: 430, forks: 43, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(430);
    expect(applied.repoStats?.stars).toBe(430);
  });
  it("applySourceRepoSignal matrix 44", () => {
    const entry = { repoUrl: "https://github.com/org-44/repo-44", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-44/repo-44", { repo: "org-44/repo-44", stars: 440, forks: 44, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(440);
    expect(applied.repoStats?.stars).toBe(440);
  });
  it("applySourceRepoSignal matrix 45", () => {
    const entry = { repoUrl: "https://github.com/org-45/repo-45", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-45/repo-45", { repo: "org-45/repo-45", stars: 450, forks: 45, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(450);
    expect(applied.repoStats?.stars).toBe(450);
  });
  it("applySourceRepoSignal matrix 46", () => {
    const entry = { repoUrl: "https://github.com/org-46/repo-46", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-46/repo-46", { repo: "org-46/repo-46", stars: 460, forks: 46, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(460);
    expect(applied.repoStats?.stars).toBe(460);
  });
  it("applySourceRepoSignal matrix 47", () => {
    const entry = { repoUrl: "https://github.com/org-47/repo-47", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-47/repo-47", { repo: "org-47/repo-47", stars: 470, forks: 47, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(470);
    expect(applied.repoStats?.stars).toBe(470);
  });
  it("applySourceRepoSignal matrix 48", () => {
    const entry = { repoUrl: "https://github.com/org-48/repo-48", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-48/repo-48", { repo: "org-48/repo-48", stars: 480, forks: 48, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(480);
    expect(applied.repoStats?.stars).toBe(480);
  });
  it("applySourceRepoSignal matrix 49", () => {
    const entry = { repoUrl: "https://github.com/org-49/repo-49", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-49/repo-49", { repo: "org-49/repo-49", stars: 490, forks: 49, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(490);
    expect(applied.repoStats?.stars).toBe(490);
  });
  it("applySourceRepoSignal matrix 50", () => {
    const entry = { repoUrl: "https://github.com/org-50/repo-50", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-50/repo-50", { repo: "org-50/repo-50", stars: 500, forks: 50, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(500);
    expect(applied.repoStats?.stars).toBe(500);
  });
  it("applySourceRepoSignal matrix 51", () => {
    const entry = { repoUrl: "https://github.com/org-51/repo-51", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-51/repo-51", { repo: "org-51/repo-51", stars: 510, forks: 51, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(510);
    expect(applied.repoStats?.stars).toBe(510);
  });
  it("applySourceRepoSignal matrix 52", () => {
    const entry = { repoUrl: "https://github.com/org-52/repo-52", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-52/repo-52", { repo: "org-52/repo-52", stars: 520, forks: 52, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(520);
    expect(applied.repoStats?.stars).toBe(520);
  });
  it("applySourceRepoSignal matrix 53", () => {
    const entry = { repoUrl: "https://github.com/org-53/repo-53", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-53/repo-53", { repo: "org-53/repo-53", stars: 530, forks: 53, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(530);
    expect(applied.repoStats?.stars).toBe(530);
  });
  it("applySourceRepoSignal matrix 54", () => {
    const entry = { repoUrl: "https://github.com/org-54/repo-54", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-54/repo-54", { repo: "org-54/repo-54", stars: 540, forks: 54, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(540);
    expect(applied.repoStats?.stars).toBe(540);
  });
  it("applySourceRepoSignal matrix 55", () => {
    const entry = { repoUrl: "https://github.com/org-55/repo-55", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-55/repo-55", { repo: "org-55/repo-55", stars: 550, forks: 55, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(550);
    expect(applied.repoStats?.stars).toBe(550);
  });
  it("applySourceRepoSignal matrix 56", () => {
    const entry = { repoUrl: "https://github.com/org-56/repo-56", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-56/repo-56", { repo: "org-56/repo-56", stars: 560, forks: 56, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(560);
    expect(applied.repoStats?.stars).toBe(560);
  });
  it("applySourceRepoSignal matrix 57", () => {
    const entry = { repoUrl: "https://github.com/org-57/repo-57", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-57/repo-57", { repo: "org-57/repo-57", stars: 570, forks: 57, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(570);
    expect(applied.repoStats?.stars).toBe(570);
  });
  it("applySourceRepoSignal matrix 58", () => {
    const entry = { repoUrl: "https://github.com/org-58/repo-58", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-58/repo-58", { repo: "org-58/repo-58", stars: 580, forks: 58, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
    expect(applied.githubStars).toBe(580);
    expect(applied.repoStats?.stars).toBe(580);
  });
  it("applySourceRepoSignal matrix 59", () => {
    const entry = { repoUrl: "https://github.com/org-59/repo-59", githubStars: 1, githubForks: 1, repoUpdatedAt: "old" };
    const state: SourceRepoSignalState = { available: true, signals: new Map([["org-59/repo-59", { repo: "org-59/repo-59", stars: 590, forks: 59, repoUpdatedAt: "2026-06-01", fetchedAt: "2026-06-02", status: "ok", lastError: null }]]) };
    const applied = applySourceRepoSignal(entry, state);
