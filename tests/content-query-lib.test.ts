...
describe("content-query-lib entryDetailCacheKey", () => {
  it("entryDetailCacheKey agents 0", () => {
    expect(entryDetailCacheKey("agents", "agents-slug-0")).toBe("agents:agents-slug-0");
  });
  it("entryDetailCacheKey agents 1", () => {
    expect(entryDetailCacheKey("agents", "agents-slug-1")).toBe("agents:agents-slug-1");
  });
  it("entryDetailCacheKey agents 2", () => {
    expect(entryDetailCacheKey("agents", "agents-slug-2")).toBe("agents:agents-slug-2");
  });
  it("entryDetailCacheKey agents 3", () => {
    expect(entryDetailCacheKey("agents", "agents-slug-3")).toBe("agents:agents-slug-3");
  });
  it("entryDetailCacheKey agents 4", () => {
    expect(entryDetailCacheKey("agents", "agents-slug-4")).toBe("agents:agents-slug-4");
  });
  it("entryDetailCacheKey agents 5", () => {
    expect(entryDetailCacheKey("agents", "agents-slug-5")).toBe("agents:agents-slug-5");
  });
  it("entryDetailCacheKey agents 6", () => {
    expect(entryDetailCacheKey("agents", "agents-slug-6")).toBe("agents:agents-slug-6");
  });
  it("entryDetailCacheKey agents 7", () => {
    expect(entryDetailCacheKey("agents", "agents-slug-7")).toBe("agents:agents-slug-7");
  });
  it("entryDetailCacheKey agents 8", () => {
    expect(entryDetailCacheKey("agents", "agents-slug-8")).toBe("agents:agents-slug-8");
  });
  it("entryDetailCacheKey agents 9", () => {
    expect(entryDetailCacheKey("agents", "agents-slug-9")).toBe("agents:agents-slug-9");
  });
  ...
  it("entryDetailCacheKey tools 0", () => {
    expect(entryDetailCacheKey("tools", "tools-slug-0")).toBe("tools:tools-slug-0");
  });
  it("entryDetailCacheKey tools 1", () => {
    expect(entryDetailCacheKey("tools", "tools-slug-1")).toBe("tools:tools-slug-1");
  });
  it("entryDetailCacheKey tools 2", () => {
    expect(entryDetailCacheKey("tools", "tools-slug-2")).toBe("tools:tools-slug-2");
  });
  it("entryDetailCacheKey tools 3", () => {
    expect(entryDetailCacheKey("tools", "tools-slug-3")).toBe("tools:tools-slug-3");
  });
  it("entryDetailCacheKey tools 4", () => {
    expect(entryDetailCacheKey("tools", "tools-slug-4")).toBe("tools:tools-slug-4");
  });
  it("entryDetailCacheKey tools 5", () => {
    expect(entryDetailCacheKey("tools", "tools-slug-5")).toBe("tools:tools-slug-5");
  });
  it("entryDetailCacheKey tools 6", () => {
    expect(entryDetailCacheKey("tools", "tools-slug-6")).toBe("tools:tools-slug-6");
  });
  it("entryDetailCacheKey tools 7", () => {
    expect(entryDetailCacheKey("tools", "tools-slug-7")).toBe("tools:tools-slug-7");
  });
  it("entryDetailCacheKey tools 8", () => {
    expect(entryDetailCacheKey("tools", "tools-slug-8")).toBe("tools:tools-slug-8");
  });
  it("entryDetailCacheKey tools 9", () => {
    expect(entryDetailCacheKey("tools", "tools-slug-9")).toBe("tools:tools-slug-9");
  });
  it("entryDetailCacheKey skills 0", () => {
    expect(entryDetailCacheKey("skills", "skills-slug-0")).toBe("skills:skills-slug-0");
  });
  it("entryDetailCacheKey skills 1", () => {
    expect(entryDetailCacheKey("skills", "skills-slug-1")).toBe("skills:skills-slug-1");
  });
  it("entryDetailCacheKey skills 2", () => {
    expect(entryDetailCacheKey("skills", "skills-slug-2")).toBe("skills:skills-slug-2");
  });
  it("entryDetailCacheKey skills 3", () => {
    expect(entryDetailCacheKey("skills", "skills-slug-3")).toBe("skills:skills-slug-3");
  });
  it("entryDetailCacheKey skills 4", () => {
    expect(entryDetailCacheKey("skills", "skills-slug-4")).toBe("skills:skills-slug-4");
  });
  it("entryDetailCacheKey skills 5", () => {
    expect(entryDetailCacheKey("skills", "skills-slug-5")).toBe("skills:skills-slug-5");
  });
  it("entryDetailCacheKey skills 6", () => {
    expect(entryDetailCacheKey("skills", "skills-slug-6")).toBe("skills:skills-slug-6");
  });
  it("entryDetailCacheKey skills 7", () => {
    expect(entryDetailCacheKey("skills", "skills-slug-7")).toBe("skills:skills-slug-7");
  });
  it("entryDetailCacheKey skills 8", () => {
    expect(entryDetailCacheKey("skills", "skills-slug-8")).toBe("skills:skills-slug-8");
  });
  it("entryDetailCacheKey skills 9", () => {
    expect(entryDetailCacheKey("skills", "skills-slug-9")).toBe("skills:skills-slug-9");
  });
  it("entryDetailCacheKey rules 0", () => {
    expect(entryDetailCacheKey("rules", "rules-slug-0")).toBe("rules:rules-slug-0");
  });
  it("entryDetailCacheKey rules 1", () => {
    expect(entryDetailCacheKey("rules", "rules-slug-1")).toBe("rules:rules-slug-1");
  });
  it("entryDetailCacheKey rules 2", () => {
    expect(entryDetailCacheKey("rules", "rules-slug-2")).toBe("rules:rules-slug-2");
  });
  it("entryDetailCacheKey rules 3", () => {
    expect(entryDetailCacheKey("rules", "rules-slug-3")).toBe("rules:rules-slug-3");
  });
  it("entryDetailCacheKey rules 4", () => {
    expect(entryDetailCacheKey("rules", "rules-slug-4")).toBe("rules:rules-slug-4");
  });
  it("entryDetailCacheKey rules 5", () => {
    expect(entryDetailCacheKey("rules", "rules-slug-5")).toBe("rules:rules-slug-5");
  });
  it("entryDetailCacheKey rules 6", () => {
    expect(entryDetailCacheKey("rules", "rules-slug-6")).toBe("rules:rules-slug-6");
  });
  it("entryDetailCacheKey rules 7", () => {
    expect(entryDetailCacheKey("rules", "rules-slug-7")).toBe("rules:rules-slug-7");
  });
  it("entryDetailCacheKey rules 8", () => {
    expect(entryDetailCacheKey("rules", "rules-slug-8")).toBe("rules:rules-slug-8");
  });
  it("entryDetailCacheKey rules 9", () => {
    expect(entryDetailCacheKey("rules", "rules-slug-9")).toBe("rules:rules-slug-9");
  });
  it("entryDetailCacheKey commands 0", () => {
    expect(entryDetailCacheKey("commands", "commands-slug-0")).toBe("commands:commands-slug-0");
  });
  it("entryDetailCacheKey commands 1", () => {
    expect(entryDetailCacheKey("commands", "commands-slug-1")).toBe("commands:commands-slug-1");
  });
  it("entryDetailCacheKey commands 2", () => {
    expect(entryDetailCacheKey("commands", "commands-slug-2")).toBe("commands:commands-slug-2");
  });
  it("entryDetailCacheKey commands 3", () => {
    expect(entryDetailCacheKey("commands", "commands-slug-3")).toBe("commands:commands-slug-3");
  });
  it("entryDetailCacheKey commands 4", () => {
    expect(entryDetailCacheKey("commands", "commands-slug-4")).toBe("commands:commands-slug-4");
  });
  it("entryDetailCacheKey commands 5", () => {
    expect(entryDetailCacheKey("commands", "commands-slug-5")).toBe("commands:commands-slug-5");
  });
  it("entryDetailCacheKey commands 6", () => {
    expect(entryDetailCacheKey("commands", "commands-slug-6")).toBe("commands:commands-slug-6");
  });
  it("entryDetailCacheKey commands 7", () => {
    expect(entryDetailCacheKey("commands", "commands-slug-7")).toBe("commands:commands-slug-7");
  });
  it("entryDetailCacheKey commands 8", () => {
    expect(entryDetailCacheKey("commands", "commands-slug-8")).toBe("commands:commands-slug-8");
  });
  it("entryDetailCacheKey commands 9", () => {
    expect(entryDetailCacheKey("commands", "commands-slug-9")).toBe("commands:commands-slug-9");
  });
  it("entryDetailCacheKey hooks 0", () => {
    expect(entryDetailCacheKey("hooks", "hooks-slug-0")).toBe("hooks:hooks-slug-0");
  });
  it("entryDetailCacheKey hooks 1", () => {
    expect(entryDetailCacheKey("hooks", "hooks-slug-1")).toBe("hooks:hooks-slug-1");
  });
  it("entryDetailCacheKey hooks 2", () => {
    expect(entryDetailCacheKey("hooks", "hooks-slug-2")).toBe("hooks:hooks-slug-2");
  });
  it("entryDetailCacheKey hooks 3", () => {
    expect(entryDetailCacheKey("hooks", "hooks-slug-3")).toBe("hooks:hooks-slug-3");
  });
  it("entryDetailCacheKey hooks 4", () => {
    expect(entryDetailCacheKey("hooks", "hooks-slug-4")).toBe("hooks:hooks-slug-4");
  });
  it("entryDetailCacheKey hooks 5", () => {
    expect(entryDetailCacheKey("hooks", "hooks-slug-5")).toBe("hooks:hooks-slug-5");
  });
  it("entryDetailCacheKey hooks 6", () => {
    expect(entryDetailCacheKey("hooks", "hooks-slug-6")).toBe("hooks:hooks-slug-6");
  });
  it("entryDetailCacheKey hooks 7", () => {
    expect(entryDetailCacheKey("hooks", "hooks-slug-7")).toBe("hooks:hooks-slug-7");
  });
  it("entryDetailCacheKey hooks 8", () => {
    expect(entryDetailCacheKey("hooks", "hooks-slug-8")).toBe("hooks:hooks-slug-8");
  });
  it("entryDetailCacheKey hooks 9", () => {
    expect(entryDetailCacheKey("hooks", "hooks-slug-9")).toBe("hooks:hooks-slug-9");
  });
  it("entryDetailCacheKey guides 0", () => {
    expect(entryDetailCacheKey("guides", "guides-slug-0")).toBe("guides:guides-slug-0");
  });
  it("entryDetailCacheKey guides 1", () => {
    expect(entryDetailCacheKey("guides", "guides-slug-1")).toBe("guides:guides-slug-1");
  });
  it("entryDetailCacheKey guides 2", () => {
    expect(entryDetailCacheKey("guides", "guides-slug-2")).toBe("guides:guides-slug-2");
  });
  it("entryDetailCacheKey guides 3", () => {
    expect(entryDetailCacheKey("guides", "guides-slug-3")).toBe("guides:guides-slug-3");
  });
  it("entryDetailCacheKey guides 4", () => {
    expect(entryDetailCacheKey("guides", "guides-slug-4")).toBe("guides:guides-slug-4");
  });
  it("entryDetailCacheKey guides 5", () => {
    expect(entryDetailCacheKey("guides", "guides-slug-5")).toBe("guides:guides-slug-5");
  });
  it("entryDetailCacheKey guides 6", () => {
    expect(entryDetailCacheKey("guides", "guides-slug-6")).toBe("guides:guides-slug-6");
  });
  it("entryDetailCacheKey guides 7", () => {
    expect(entryDetailCacheKey("guides", "guides-slug-7")).toBe("guides:guides-slug-7");
  });
  it("entryDetailCacheKey guides 8", () => {
    expect(entryDetailCacheKey("guides", "guides-slug-8")).toBe("guides:guides-slug-8");
  });
  it("entryDetailCacheKey guides 9", () => {
    expect(entryDetailCacheKey("guides", "guides-slug-9")).toBe("guides:guides-slug-9");
  });
  it("entryDetailCacheKey collections 0", () => {
    expect(entryDetailCacheKey("collections", "collections-slug-0")).toBe("collections:collections-slug-0");
  });
  it("entryDetailCacheKey collections 1", () => {
    expect(entryDetailCacheKey("collections", "collections-slug-1")).toBe("collections:collections-slug-1");
  });
  it("entryDetailCacheKey collections 2", () => {
    expect(entryDetailCacheKey("collections", "collections-slug-2")).toBe("collections:collections-slug-2");
  });
  it("entryDetailCacheKey collections 3", () => {
    expect(entryDetailCacheKey("collections", "collections-slug-3")).toBe("collections:collections-slug-3");
  });
  it("entryDetailCacheKey collections 4", () => {
    expect(entryDetailCacheKey("collections", "collections-slug-4")).toBe("collections:collections-slug-4");
  });
  it("entryDetailCacheKey collections 5", () => {
    expect(entryDetailCacheKey("collections", "collections-slug-5")).toBe("collections:collections-slug-5");
  });
  it("entryDetailCacheKey collections 6", () => {
    expect(entryDetailCacheKey("collections", "collections-slug-6")).toBe("collections:collections-slug-6");
  });
  it("entryDetailCacheKey collections 7", () => {
    expect(entryDetailCacheKey("collections", "collections-slug-7")).toBe("collections:collections-slug-7");
  });
  it("entryDetailCacheKey collections 8", () => {
    expect(entryDetailCacheKey("collections", "collections-slug-8")).toBe("collections:collections-slug-8");
  });
  it("entryDetailCacheKey collections 9", () => {
    expect(entryDetailCacheKey("collections", "collections-slug-9")).toBe("collections:collections-slug-9");
  });
  it("entryDetailCacheKey statuslines 0", () => {
    expect(entryDetailCacheKey("statuslines", "statuslines-slug-0")).toBe("statuslines:statuslines-slug-0");
  });
  it("entryDetailCacheKey statuslines 1", () => {
    expect(entryDetailCacheKey("statuslines", "statuslines-slug-1")).toBe("statuslines:statuslines-slug-1");
  });
  it("entryDetailCacheKey statuslines 2", () => {
    expect(entryDetailCacheKey("statuslines", "statuslines-slug-2")).toBe("statuslines:statuslines-slug-2");
  });
  it("entryDetailCacheKey statuslines 3", () => {
    expect(entryDetailCacheKey("statuslines", "statuslines-slug-3")).toBe("statuslines:statuslines-slug-3");
  });
  it("entryDetailCacheKey statuslines 4", () => {
    expect(entryDetailCacheKey("statuslines", "statuslines-slug-4")).toBe("statuslines:statuslines-slug-4");
  });
  it("entryDetailCacheKey statuslines 5", () => {
    expect(entryDetailCacheKey("statuslines", "statuslines-slug-5")).toBe("statuslines:statuslines-slug-5");
  });
  it("entryDetailCacheKey statuslines 6", () => {
    expect(entryDetailCacheKey("statuslines", "statuslines-slug-6")).toBe("statuslines:statuslines-slug-6");
  });
  it("entryDetailCacheKey statuslines 7", () => {
    expect(entryDetailCacheKey("statuslines", "statuslines-slug-7")).toBe("statuslines:statuslines-slug-7");
  });
  it("entryDetailCacheKey statuslines 8", () => {
    expect(entryDetailCacheKey("statuslines", "statuslines-slug-8")).toBe("statuslines:statuslines-slug-8");
  });
  it("entryDetailCacheKey statuslines 9", () => {
    expect(entryDetailCacheKey("statuslines", "statuslines-slug-9")).toBe("statuslines:statuslines-slug-9");
  });
});
...
describe("content-query-lib buildCategorySummaries", () => {
  ...
  it("buildCategorySummaries agents count 0", () => {
    const entries = Array.from({ length: 1 }, (_, idx) => ({ category: "agents", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["agents"], { "agents": "agents" }, { "agents": "desc" });
    expect(summaries[0]?.count).toBe(1);
  });
  it("buildCategorySummaries agents count 1", () => {
    const entries = Array.from({ length: 2 }, (_, idx) => ({ category: "agents", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["agents"], { "agents": "agents" }, { "agents": "desc" });
    expect(summaries[0]?.count).toBe(2);
  });
  it("buildCategorySummaries agents count 2", () => {
    const entries = Array.from({ length: 3 }, (_, idx) => ({ category: "agents", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["agents"], { "agents": "agents" }, { "agents": "desc" });
    expect(summaries[0]?.count).toBe(3);
  });
  it("buildCategorySummaries agents count 3", () => {
    const entries = Array.from({ length: 4 }, (_, idx) => ({ category: "agents", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["agents"], { "agents": "agents" }, { "agents": "desc" });
    expect(summaries[0]?.count).toBe(4);
  });
  it("buildCategorySummaries agents count 4", () => {
    const entries = Array.from({ length: 5 }, (_, idx) => ({ category: "agents", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["agents"], { "agents": "agents" }, { "agents": "desc" });
    expect(summaries[0]?.count).toBe(5);
  });
  it("buildCategorySummaries agents count 5", () => {
    const entries = Array.from({ length: 6 }, (_, idx) => ({ category: "agents", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["agents"], { "agents": "agents" }, { "agents": "desc" });
    expect(summaries[0]?.count).toBe(6);
  });
  it("buildCategorySummaries agents count 6", () => {
    const entries = Array.from({ length: 7 }, (_, idx) => ({ category: "agents", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["agents"], { "agents": "agents" }, { "agents": "desc" });
    expect(summaries[0]?.count).toBe(7);
  });
  it("buildCategorySummaries agents count 7", () => {
    const entries = Array.from({ length: 8 }, (_, idx) => ({ category: "agents", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["agents"], { "agents": "agents" }, { "agents": "desc" });
    expect(summaries[0]?.count).toBe(8);
  });
  it("buildCategorySummaries mcp count 0", () => {
    const entries = Array.from({ length: 1 }, (_, idx) => ({ category: "mcp", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["mcp"], { "mcp": "mcp" }, { "mcp": "desc" });
    expect(summaries[0]?.count).toBe(1);
  });
  it("buildCategorySummaries mcp count 1", () => {
    const entries = Array.from({ length: 2 }, (_, idx) => ({ category: "mcp", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["mcp"], { "mcp": "mcp" }, { "mcp": "desc" });
    expect(summaries[0]?.count).toBe(2);
  });
  it("buildCategorySummaries mcp count 2", () => {
    const entries = Array.from({ length: 3 }, (_, idx) => ({ category: "mcp", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["mcp"], { "mcp": "mcp" }, { "mcp": "desc" });
    expect(summaries[0]?.count).toBe(3);
  });
  it("buildCategorySummaries mcp count 3", () => {
    const entries = Array.from({ length: 4 }, (_, idx) => ({ category: "mcp", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["mcp"], { "mcp": "mcp" }, { "mcp": "desc" });
    expect(summaries[0]?.count).toBe(4);
  });
  it("buildCategorySummaries mcp count 4", () => {
    const entries = Array.from({ length: 5 }, (_, idx) => ({ category: "mcp", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["mcp"], { "mcp": "mcp" }, { "mcp": "desc" });
    expect(summaries[0]?.count).toBe(5);
  });
  it("buildCategorySummaries mcp count 5", () => {
    const entries = Array.from({ length: 6 }, (_, idx) => ({ category: "mcp", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["mcp"], { "mcp": "mcp" }, { "mcp": "desc" });
    expect(summaries[0]?.count).toBe(6);
  });
  it("buildCategorySummaries mcp count 6", () => {
    const entries = Array.from({ length: 7 }, (_, idx) => ({ category: "mcp", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["mcp"], { "mcp": "mcp" }, { "mcp": "desc" });
    expect(summaries[0]?.count).toBe(7);
  });
  it("buildCategorySummaries mcp count 7", () => {
    const entries = Array.from({ length: 8 }, (_, idx) => ({ category: "mcp", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["mcp"], { "mcp": "mcp" }, { "mcp": "desc" });
    expect(summaries[0]?.count).toBe(8);
  });
  it("buildCategorySummaries tools count 0", () => {
    const entries = Array.from({ length: 1 }, (_, idx) => ({ category: "tools", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["tools"], { "tools": "tools" }, { "tools": "desc" });
    expect(summaries[0]?.count).toBe(1);
  });
  it("buildCategorySummaries tools count 1", () => {
    const entries = Array.from({ length: 2 }, (_, idx) => ({ category: "tools", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["tools"], { "tools": "tools" }, { "tools": "desc" });
    expect(summaries[0]?.count).toBe(2);
  });
  it("buildCategorySummaries tools count 2", () => {
    const entries = Array.from({ length: 3 }, (_, idx) => ({ category: "tools", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["tools"], { "tools": "tools" }, { "tools": "desc" });
    expect(summaries[0]?.count).toBe(3);
  });
  it("buildCategorySummaries tools count 3", () => {
    const entries = Array.from({ length: 4 }, (_, idx) => ({ category: "tools", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["tools"], { "tools": "tools" }, { "tools": "desc" });
    expect(summaries[0]?.count).toBe(4);
  });
  it("buildCategorySummaries tools count 4", () => {
    const entries = Array.from({ length: 5 }, (_, idx) => ({ category: "tools", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["tools"], { "tools": "tools" }, { "tools": "desc" });
    expect(summaries[0]?.count).toBe(5);
  });
  it("buildCategorySummaries tools count 5", () => {
    const entries = Array.from({ length: 6 }, (_, idx) => ({ category: "tools", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["tools"], { "tools": "tools" }, { "tools": "desc" });
    expect(summaries[0]?.count).toBe(6);
  });
  it("buildCategorySummaries tools count 6", () => {
    const entries = Array.from({ length: 7 }, (_, idx) => ({ category: "tools", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["tools"], { "tools": "tools" }, { "tools": "desc" });
    expect(summaries[0]?.count).toBe(7);
  });
  it("buildCategorySummaries tools count 7", () => {
    const entries = Array.from({ length: 8 }, (_, idx) => ({ category: "tools", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["tools"], { "tools": "tools" }, { "tools": "desc" });
    expect(summaries[0]?.count).toBe(8);
  });
  it("buildCategorySummaries skills count 0", () => {
    const entries = Array.from({ length: 1 }, (_, idx) => ({ category: "skills", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["skills"], { "skills": "skills" }, { "skills": "desc" });
    expect(summaries[0]?.count).toBe(1);
  });
  it("buildCategorySummaries skills count 1", () => {
    const entries = Array.from({ length: 2 }, (_, idx) => ({ category: "skills", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["skills"], { "skills": "skills" }, { "skills": "desc" });
    expect(summaries[0]?.count).toBe(2);
  });
  it("buildCategorySummaries skills count 2", () => {
    const entries = Array.from({ length: 3 }, (_, idx) => ({ category: "skills", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["skills"], { "skills": "skills" }, { "skills": "desc" });
    expect(summaries[0]?.count).toBe(3);
  });
  it("buildCategorySummaries skills count 3", () => {
    const entries = Array.from({ length: 4 }, (_, idx) => ({ category: "skills", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["skills"], { "skills": "skills" }, { "skills": "desc" });
    expect(summaries[0]?.count).toBe(4);
  });
  it("buildCategorySummaries skills count 4", () => {
    const entries = Array.from({ length: 5 }, (_, idx) => ({ category: "skills", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["skills"], { "skills": "skills" }, { "skills": "desc" });
    expect(summaries[0]?.count).toBe(5);
  });
  it("buildCategorySummaries skills count 5", () => {
    const entries = Array.from({ length: 6 }, (_, idx) => ({ category: "skills", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["skills"], { "skills": "skills" }, { "skills": "desc" });
    expect(summaries[0]?.count).toBe(6);
  });
  it("buildCategorySummaries skills count 6", () => {
    const entries = Array.from({ length: 7 }, (_, idx) => ({ category: "skills", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["skills"], { "skills": "skills" }, { "skills": "desc" });
    expect(summaries[0]?.count).toBe(7);
  });
  it("buildCategorySummaries skills count 7", () => {
    const entries = Array.from({ length: 8 }, (_, idx) => ({ category: "skills", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["skills"], { "skills": "skills" }, { "skills": "desc" });
    expect(summaries[0]?.count).toBe(8);
  });
  it("buildCategorySummaries rules count 0", () => {
    const entries = Array.from({ length: 1 }, (_, idx) => ({ category: "rules", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["rules"], { "rules": "rules" }, { "rules": "desc" });
    expect(summaries[0]?.count).toBe(1);
  });
  it("buildCategorySummaries rules count 1", () => {
    const entries = Array.from({ length: 2 }, (_, idx) => ({ category: "rules", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["rules"], { "rules": "rules" }, { "rules": "desc" });
    expect(summaries[0]?.count).toBe(2);
  });
  it("buildCategorySummaries rules count 2", () => {
    const entries = Array.from({ length: 3 }, (_, idx) => ({ category: "rules", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["rules"], { "rules": "rules" }, { "rules": "desc" });
    expect(summaries[0]?.count).toBe(3);
  });
  it("buildCategorySummaries rules count 3", () => {
    const entries = Array.from({ length: 4 }, (_, idx) => ({ category: "rules", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["rules"], { "rules": "rules" }, { "rules": "desc" });
    expect(summaries[0]?.count).toBe(4);
  });
  it("buildCategorySummaries rules count 4", () => {
    const entries = Array.from({ length: 5 }, (_, idx) => ({ category: "rules", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["rules"], { "rules": "rules" }, { "rules": "desc" });
    expect(summaries[0]?.count).toBe(5);
  });
  it("buildCategorySummaries rules count 5", () => {
    const entries = Array.from({ length: 6 }, (_, idx) => ({ category: "rules", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["rules"], { "rules": "rules" }, { "rules": "desc" });
    expect(summaries[0]?.count).toBe(6);
  });
  it("buildCategorySummaries rules count 6", () => {
    const entries = Array.from({ length: 7 }, (_, idx) => ({ category: "rules", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["rules"], { "rules": "rules" }, { "rules": "desc" });
    expect(summaries[0]?.count).toBe(7);
  });
  it("buildCategorySummaries rules count 7", () => {
    const entries = Array.from({ length: 8 }, (_, idx) => ({ category: "rules", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["rules"], { "rules": "rules" }, { "rules": "desc" });
    expect(summaries[0]?.count).toBe(8);
  });
  it("buildCategorySummaries commands count 0", () => {
    const entries = Array.from({ length: 1 }, (_, idx) => ({ category: "commands", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["commands"], { "commands": "commands" }, { "commands": "desc" });
    expect(summaries[0]?.count).toBe(1);
  });
  it("buildCategorySummaries commands count 1", () => {
    const entries = Array.from({ length: 2 }, (_, idx) => ({ category: "commands", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["commands"], { "commands": "commands" }, { "commands": "desc" });
    expect(summaries[0]?.count).toBe(2);
  });
  it("buildCategorySummaries commands count 2", () => {
    const entries = Array.from({ length: 3 }, (_, idx) => ({ category: "commands", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["commands"], { "commands": "commands" }, { "commands": "desc" });
    expect(summaries[0]?.count).toBe(3);
  });
  it("buildCategorySummaries commands count 3", () => {
    const entries = Array.from({ length: 4 }, (_, idx) => ({ category: "commands", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["commands"], { "commands": "commands" }, { "commands": "desc" });
    expect(summaries[0]?.count).toBe(4);
  });
  it("buildCategorySummaries commands count 4", () => {
    const entries = Array.from({ length: 5 }, (_, idx) => ({ category: "commands", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["commands"], { "commands": "commands" }, { "commands": "desc" });
    expect(summaries[0]?.count).toBe(5);
  });
  it("buildCategorySummaries commands count 5", () => {
    const entries = Array.from({ length: 6 }, (_, idx) => ({ category: "commands", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["commands"], { "commands": "commands" }, { "commands": "desc" });
    expect(summaries[0]?.count).toBe(6);
  });
  it("buildCategorySummaries commands count 6", () => {
    const entries = Array.from({ length: 7 }, (_, idx) => ({ category: "commands", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["commands"], { "commands": "commands" }, { "commands": "desc" });
    expect(summaries[0]?.count).toBe(7);
  });
  it("buildCategorySummaries commands count 7", () => {
    const entries = Array.from({ length: 8 }, (_, idx) => ({ category: "commands", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["commands"], { "commands": "commands" }, { "commands": "desc" });
    expect(summaries[0]?.count).toBe(8);
  });
  it("buildCategorySummaries hooks count 0", () => {
    const entries = Array.from({ length: 1 }, (_, idx) => ({ category: "hooks", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["hooks"], { "hooks": "hooks" }, { "hooks": "desc" });
    expect(summaries[0]?.count).toBe(1);
  });
  it("buildCategorySummaries hooks count 1", () => {
    const entries = Array.from({ length: 2 }, (_, idx) => ({ category: "hooks", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["hooks"], { "hooks": "hooks" }, { "hooks": "desc" });
    expect(summaries[0]?.count).toBe(2);
  });
  it("buildCategorySummaries hooks count 2", () => {
    const entries = Array.from({ length: 3 }, (_, idx) => ({ category: "hooks", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["hooks"], { "hooks": "hooks" }, { "hooks": "desc" });
    expect(summaries[0]?.count).toBe(3);
  });
  it("buildCategorySummaries hooks count 3", () => {
    const entries = Array.from({ length: 4 }, (_, idx) => ({ category: "hooks", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["hooks"], { "hooks": "hooks" }, { "hooks": "desc" });
    expect(summaries[0]?.count).toBe(4);
  });
  it("buildCategorySummaries hooks count 4", () => {
    const entries = Array.from({ length: 5 }, (_, idx) => ({ category: "hooks", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["hooks"], { "hooks": "hooks" }, { "hooks": "desc" });
    expect(summaries[0]?.count).toBe(5);
  });
  it("buildCategorySummaries hooks count 5", () => {
    const entries = Array.from({ length: 6 }, (_, idx) => ({ category: "hooks", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["hooks"], { "hooks": "hooks" }, { "hooks": "desc" });
    expect(summaries[0]?.count).toBe(6);
  });
  it("buildCategorySummaries hooks count 6", () => {
    const entries = Array.from({ length: 7 }, (_, idx) => ({ category: "hooks", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["hooks"], { "hooks": "hooks" }, { "hooks": "desc" });
    expect(summaries[0]?.count).toBe(7);
  });
  it("buildCategorySummaries hooks count 7", () => {
    const entries = Array.from({ length: 8 }, (_, idx) => ({ category: "hooks", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["hooks"], { "hooks": "hooks" }, { "hooks": "desc" });
    expect(summaries[0]?.count).toBe(8);
  });
  it("buildCategorySummaries guides count 0", () => {
    const entries = Array.from({ length: 1 }, (_, idx) => ({ category: "guides", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["guides"], { "guides": "guides" }, { "guides": "desc" });
    expect(summaries[0]?.count).toBe(1);
  });
  it("buildCategorySummaries guides count 1", () => {
    const entries = Array.from({ length: 2 }, (_, idx) => ({ category: "guides", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["guides"], { "guides": "guides" }, { "guides": "desc" });
    expect(summaries[0]?.count).toBe(2);
  });
  it("buildCategorySummaries guides count 2", () => {
    const entries = Array.from({ length: 3 }, (_, idx) => ({ category: "guides", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["guides"], { "guides": "guides" }, { "guides": "desc" });
    expect(summaries[0]?.count).toBe(3);
  });
  it("buildCategorySummaries guides count 3", () => {
    const entries = Array.from({ length: 4 }, (_, idx) => ({ category: "guides", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["guides"], { "guides": "guides" }, { "guides": "desc" });
    expect(summaries[0]?.count).toBe(4);
  });
  it("buildCategorySummaries guides count 4", () => {
    const entries = Array.from({ length: 5 }, (_, idx) => ({ category: "guides", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["guides"], { "guides": "guides" }, { "guides": "desc" });
    expect(summaries[0]?.count).toBe(5);
  });
  it("buildCategorySummaries guides count 5", () => {
    const entries = Array.from({ length: 6 }, (_, idx) => ({ category: "guides", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["guides"], { "guides": "guides" }, { "guides": "desc" });
    expect(summaries[0]?.count).toBe(6);
  });
  it("buildCategorySummaries guides count 6", () => {
    const entries = Array.from({ length: 7 }, (_, idx) => ({ category: "guides", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["guides"], { "guides": "guides" }, { "guides": "desc" });
    expect(summaries[0]?.count).toBe(7);
  });
  it("buildCategorySummaries guides count 7", () => {
    const entries = Array.from({ length: 8 }, (_, idx) => ({ category: "guides", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["guides"], { "guides": "guides" }, { "guides": "desc" });
    expect(summaries[0]?.count).toBe(8);
  });
  it("buildCategorySummaries collections count 0", () => {
    const entries = Array.from({ length: 1 }, (_, idx) => ({ category: "collections", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["collections"], { "collections": "collections" }, { "collections": "desc" });
    expect(summaries[0]?.count).toBe(1);
  });
  it("buildCategorySummaries collections count 1", () => {
    const entries = Array.from({ length: 2 }, (_, idx) => ({ category: "collections", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["collections"], { "collections": "collections" }, { "collections": "desc" });
    expect(summaries[0]?.count).toBe(2);
  });
  it("buildCategorySummaries collections count 2", () => {
    const entries = Array.from({ length: 3 }, (_, idx) => ({ category: "collections", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["collections"], { "collections": "collections" }, { "collections": "desc" });
    expect(summaries[0]?.count).toBe(3);
  });
  it("buildCategorySummaries collections count 3", () => {
    const entries = Array.from({ length: 4 }, (_, idx) => ({ category: "collections", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["collections"], { "collections": "collections" }, { "collections": "desc" });
    expect(summaries[0]?.count).toBe(4);
  });
  it("buildCategorySummaries collections count 4", () => {
    const entries = Array.from({ length: 5 }, (_, idx) => ({ category: "collections", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["collections"], { "collections": "collections" }, { "collections": "desc" });
    expect(summaries[0]?.count).toBe(5);
  });
  it("buildCategorySummaries collections count 5", () => {
    const entries = Array.from({ length: 6 }, (_, idx) => ({ category: "collections", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["collections"], { "collections": "collections" }, { "collections": "desc" });
    expect(summaries[0]?.count).toBe(6);
  });
  it("buildCategorySummaries collections count 6", () => {
    const entries = Array.from({ length: 7 }, (_, idx) => ({ category: "collections", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["collections"], { "collections": "collections" }, { "collections": "desc" });
    expect(summaries[0]?.count).toBe(7);
  });
  it("buildCategorySummaries collections count 7", () => {
    const entries = Array.from({ length: 8 }, (_, idx) => ({ category: "collections", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["collections"], { "collections": "collections" }, { "collections": "desc" });
    expect(summaries[0]?.count).toBe(8);
  });
  it("buildCategorySummaries statuslines count 0", () => {
    const entries = Array.from({ length: 1 }, (_, idx) => ({ category: "statuslines", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["statuslines"], { "statuslines": "statuslines" }, { "statuslines": "desc" });
    expect(summaries[0]?.count).toBe(1);
  });
  it("buildCategorySummaries statuslines count 1", () => {
    const entries = Array.from({ length: 2 }, (_, idx) => ({ category: "statuslines", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["statuslines"], { "statuslines": "statuslines" }, { "statuslines": "desc" });
    expect(summaries[0]?.count).toBe(2);
  });
  it("buildCategorySummaries statuslines count 2", () => {
    const entries = Array.from({ length: 3 }, (_, idx) => ({ category: "statuslines", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["statuslines"], { "statuslines": "statuslines" }, { "statuslines": "desc" });
    expect(summaries[0]?.count).toBe(3);
  });
  it("buildCategorySummaries statuslines count 3", () => {
    const entries = Array.from({ length: 4 }, (_, idx) => ({ category: "statuslines", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["statuslines"], { "statuslines": "statuslines" }, { "statuslines": "desc" });
    expect(summaries[0]?.count).toBe(4);
  });
  it("buildCategorySummaries statuslines count 4", () => {
    const entries = Array.from({ length: 5 }, (_, idx) => ({ category: "statuslines", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["statuslines"], { "statuslines": "statuslines" }, { "statuslines": "desc" });
    expect(summaries[0]?.count).toBe(5);
  });
  it("buildCategorySummaries statuslines count 5", () => {
    const entries = Array.from({ length: 6 }, (_, idx) => ({ category: "statuslines", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["statuslines"], { "statuslines": "statuslines" }, { "statuslines": "desc" });
    expect(summaries[0]?.count).toBe(6);
  });
  it("buildCategorySummaries statuslines count 6", () => {
    const entries = Array.from({ length: 7 }, (_, idx) => ({ category: "statuslines", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["statuslines"], { "statuslines": "statuslines" }, { "statuslines": "desc" });
    expect(summaries[0]?.count).toBe(7);
  });
  it("buildCategorySummaries statuslines count 7", () => {
    const entries = Array.from({ length: 8 }, (_, idx) => ({ category: "statuslines", slug: "slug-" + idx, title: "T", dateAdded: "2026-01-01" }));
    const summaries = buildCategorySummaries(entries, ["statuslines"], { "statuslines": "statuslines" }, { "statuslines": "desc" });
    expect(summaries[0]?.count).toBe(8);
  });
});
