...
export function hasWorldWritableChmod(line: string, lowerLine: string): boolean;
...
export function hasPipeToShellInstall(line: string, lowerLine: string): boolean;

export function hasBase64DecodedShell(line: string, lowerLine: string): boolean;
