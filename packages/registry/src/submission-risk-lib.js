 ...
 *
 * Deterministic security/safety scoring for submission drafts and direct
 * content PRs. Pattern matching, provenance validation, and policy-matrix
 * builders live here — nothing touches the network; given the same inputs the
