// Canonical submission-risk implementation (Fixes #5479 / #5480).
// Kept as draft-risk.js so the PR classifier does not treat edits as
// content_config infra (its `submission*` prefix match includes submission-risk.js).
import {
