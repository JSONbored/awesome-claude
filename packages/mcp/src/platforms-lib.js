/**
 * Pure MCP platform slug and skill compatibility helpers.
 *
 * Platform feed slugs and skill platform compatibility rows for MCP registry
 * responses. The public surface (`platforms.js`) re-exports everything below.
 */
