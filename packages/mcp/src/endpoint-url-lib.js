/**
 * Pure MCP endpoint URL normalization helpers.
 *
 * HTTPS enforcement and timeout clamping for remote MCP clients. The public
 * surface (`endpoint-url.js`) re-exports everything below.
 */
