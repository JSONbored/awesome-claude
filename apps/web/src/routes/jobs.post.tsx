  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
      ...
      >
        ...
        <Field label="Company URL" type="url" required />
        <Field label="Location" required />
        <div className="grid gap-4 sm:grid-cols-2">
          <Field label="Employment type" placeholder="Full-time, Contract…" required />
          <Field label="Compensation" placeholder="$210k–$300k" />
        </div>
        <TextArea label="Description" required />
        <Field label="Apply URL" type="url" required />
        <Field label="Your email (we'll contact you for verification)" type="email" required />
