...
export const AI_BOTS: readonly AiBot[] = [
  ...
  { token: "Google-Extended", operator: "google", purpose: "train" },
  { token: "GoogleOther", operator: "google", purpose: "other" },
  { token: "Gemini-User", operator: "google", purpose: "user" },
  ...
  { token: "cohere-ai", operator: "cohere", purpose: "train" },
  { token: "YouBot", operator: "you", purpose: "search" },
  { token: "PhindBot", operator: "phind", purpose: "search" },
  { token: "BraveBot", operator: "brave", purpose: "search" },
