...
category: skills
description: >-
  Expert Claude Code computer use GUI QA capability pack for designing, reviewing, and rolling out computer use GUI QA with source-backed checklists, production rules, and privacy-safe output contracts.
cardDescription: >-
  Review and operationalize computer use GUI QA with source-backed Claude Code checklists.
seoTitle: Claude Code computer use GUI QA Capability Pack Skill
seoDescription: >-
  Source-backed capability pack for computer use GUI QA: workflow steps, review matrix, troubleshooting, and rollout notes aligned to official Claude Code documentation.
author: kiannidev
...
installable: false
usageSnippet: >-
  Use this skill when planning or hardening computer use GUI QA in Claude Code, Agent SDK, or MCP integrations.
copySnippet: |-
  # Trigger
  "Apply the Claude Code computer use GUI QA capability pack for this environment."
  
  # Required output
  1) computer use GUI QA scope and current configuration summary
...
testedPlatforms:
  ...
  - Generic AGENTS
prerequisites:
  - "Access to Claude Code or Agent SDK environment where computer use GUI QA will run."
...
safetyNotes:
  - "This skill plans computer use GUI QA; it must not execute destructive changes without explicit approval."
...
privacyNotes:
  - "Reviews may expose integration tokens, customer metadata, and internal URLs related to computer use GUI QA."
...
keywords:
  ...
  - "Claude Code computer use GUI QA"
  - "computer use GUI QA review checklist"
  - "computer use GUI QA production rules"
  - "Claude Code computer use GUI QA rollout"
  - "computer use GUI QA troubleshooting"
readingTime: 9
difficultyScore: 82
...
This capability pack is grounded in Claude Code computer-use, chrome, security, and sandboxing documentation
...
- Official docs for computer use GUI QA are published on code.claude.com with settings and security cross-links.
...
This is not vendor professional services. Use it as a reusable review workflow for computer use GUI QA on Claude Code and related Agent SDK surfaces.

## Core Workflow

1. Confirm prerequisites, account plan, and Claude Code or SDK version for computer use GUI QA.
...
- computer use GUI QA scope definition.
...
- **Claude Code / Claude**: use as an Agent Skill when preparing computer use GUI QA
...
- **Codex, Cursor, Windsurf, and Generic AGENTS workflows**: use the workflow as a
  deterministic checklist for computer use GUI QA evaluations on Claude Code projects.
...
requests for Claude Code computer use GUI QA, computer use GUI QA, and Claude Code capability pack workflows. Official docs describe the feature directly, but
