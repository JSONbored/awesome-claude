...
category: skills
description: >-
  Expert Claude Code Chrome browser QA capability pack for designing, reviewing, and rolling out Chrome browser QA with source-backed checklists, production rules, and privacy-safe output contracts.
cardDescription: >-
  Review and operationalize Chrome browser QA with source-backed Claude Code checklists.
seoTitle: Claude Code Chrome browser QA Capability Pack Skill
seoDescription: >-
  Source-backed capability pack for Chrome browser QA: workflow steps, review matrix, troubleshooting, and rollout notes aligned to official Claude Code documentation.
author: kiannidev
...
installable: false
usageSnippet: >-
  Use this skill when planning or hardening Chrome browser QA in Claude Code, Agent SDK, or MCP integrations.
copySnippet: |-
  # Trigger
  "Apply the Claude Code Chrome browser QA capability pack for this environment."
  
  # Required output
  1) Chrome browser QA scope and current configuration summary
...
testedPlatforms:
  ...
  - Generic AGENTS
prerequisites:
  - "Access to Claude Code or Agent SDK environment where Chrome browser QA will run."
...
safetyNotes:
  - "This skill plans Chrome browser QA; it must not execute destructive changes without explicit approval."
...
privacyNotes:
  - "Reviews may expose integration tokens, customer metadata, and internal URLs related to Chrome browser QA."
...
keywords:
  ...
  - "Claude Code Chrome browser QA"
  - "Chrome browser QA review checklist"
  - "Chrome browser QA production rules"
  - "Claude Code Chrome browser QA rollout"
  - "Chrome browser QA troubleshooting"
readingTime: 8
difficultyScore: 78
...
This capability pack is grounded in Claude Code chrome, computer-use, security, and skills documentation
...
- Official docs for Chrome browser QA are published on code.claude.com with settings and security cross-links.
...
This is not vendor professional services. Use it as a reusable review workflow for Chrome browser QA on Claude Code and related Agent SDK surfaces.

## Core Workflow

1. Confirm prerequisites, account plan, and Claude Code or SDK version for Chrome browser QA.
...
- Chrome browser QA scope definition.
...
- **Claude Code / Claude**: use as an Agent Skill when preparing Chrome browser QA
...
- **Codex, Cursor, Windsurf, and Generic AGENTS workflows**: use the workflow as a
  deterministic checklist for Chrome browser QA evaluations on Claude Code projects.
...
requests for Claude Code Chrome browser QA, Chrome browser QA, and Claude Code capability pack workflows. Official docs describe the feature directly, but
