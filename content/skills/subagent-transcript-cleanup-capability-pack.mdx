...
category: skills
description: >-
  Community capability pack for cleaning subagent output before parent-session handoff
  using official Claude Code sub-agents documentation: isolated context boundaries,
  summary contracts, retention limits, and privacy-safe closeout checklists.
cardDescription: Clean subagent output for parent handoff using official sub-agents documentation.
...
installable: false
usageSnippet: >-
  Use this skill after subagent work completes to redact sensitive output, produce
...
testedPlatforms:
  ...
  - Generic AGENTS
prerequisites:
  - "Completed or paused subagent session with tool output to review."
...
safetyNotes:
  - "Do not merge unreviewed subagent output when destructive actions were attempted."
...
overview documentation verified on **2026-06-14**. Subagent isolation and handoff
...
Verified against official Claude Code sub-agents documentation on **2026-06-14**:

- Claude Code subagents run in isolated context windows, keeping exploration out of the main session window.
