...
category: skills
description: >-
  Expert Claude Code Slack triage capability pack for designing, reviewing, and rolling out Slack triage with source-backed checklists, production rules, and privacy-safe output contracts.
cardDescription: >-
  Review and operationalize Slack triage with source-backed Claude Code checklists.
seoTitle: Claude Code Slack triage Capability Pack Skill
seoDescription: >-
  Source-backed capability pack for Slack triage: workflow steps, review matrix, troubleshooting, and rollout notes aligned to official Claude Code documentation.
author: kiannidev
...
installable: false
usageSnippet: >-
  Use this skill when planning or hardening Slack triage in Claude Code, Agent SDK, or MCP integrations.
copySnippet: |-
  # Trigger
  "Apply the Claude Code Slack triage capability pack for this environment."
  
  # Required output
  1) Slack triage scope and current configuration summary
...
retrievalSources:
  ...
  - "https://code.claude.com/docs/en/integrations"
...
testedPlatforms:
  ...
  - Generic AGENTS
prerequisites:
  - "Access to Claude Code or Agent SDK environment where Slack triage will run."
...
safetyNotes:
  - "This skill plans Slack triage; it must not execute destructive changes without explicit approval."
...
privacyNotes:
  - "Reviews may expose integration tokens, customer metadata, and internal URLs related to Slack triage."
...
keywords:
  ...
  - "Claude Code Slack triage"
  - "Slack triage review checklist"
  - "Slack triage production rules"
  - "Claude Code Slack triage rollout"
  - "Slack triage troubleshooting"
readingTime: 8
difficultyScore: 76
...
This capability pack is grounded in Claude Code slack, integrations, security, and skills documentation
...
- Official docs for Slack triage are published on code.claude.com with settings and security cross-links.
...
This is not vendor professional services. Use it as a reusable review workflow for Slack triage on Claude Code and related Agent SDK surfaces.

## Core Workflow

1. Confirm prerequisites, account plan, and Claude Code or SDK version for Slack triage.
...
- **Claude Code / Claude**: use as an Agent Skill when preparing Slack triage
...
- **Codex, Cursor, Windsurf, and Generic AGENTS workflows**: use the workflow as a
  deterministic checklist for Slack triage evaluations on Claude Code projects.
...
requests for Claude Code Slack triage, Slack triage, and Claude Code capability pack workflows. Official docs describe the feature directly, but
