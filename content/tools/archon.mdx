...
prerequisites:
  - "Git clone of https://github.com/coleam00/Archon following repository setup instructions."
  - "Bun and Claude Code installed per Archon repository prerequisites."
  - "GitHub CLI when using repository workflows that create or review pull requests."
  - "Target project repository where Archon skills and workflow files will be copied or configured."
safetyNotes:
  - "Install from the GitHub repository only; do not use pipe-to-shell installers from third-party domains."
  - "Workflows can run bash scripts, tests, and git operations in isolated worktrees; review YAML before execution."
  - "Self-hosted deployments require patching and backup like other internal developer platforms."
  - "Telemetry is enabled by default in Archon; review repository telemetry documentation before enterprise rollout."
privacyNotes:
...
Verified against the public Archon repository README on **2026-06-15**:
