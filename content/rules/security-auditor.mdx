...
privacyNotes:
  - "Security review reads source, configuration, and logs that may contain secrets, tokens, or personal data; keep any captured sensitive values out of shared findings and committed files."
tags:
  - security
  - penetration-testing
  - vulnerability
