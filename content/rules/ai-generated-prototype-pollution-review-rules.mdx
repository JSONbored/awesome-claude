...
description: >-
  ...
  merge/clone/assign helpers on untrusted input, __proto__/constructor.
  prototype key handling, and safer alternatives like Map, Set, and
  Object.create(null).
cardDescription: >-
  Review AI-generated JS/TS merge, clone, and object-assignment code for
  prototype pollution: block __proto__/constructor.prototype keys, prefer
...
seoDescription: >-
  ...
  recursive merge/clone/assign helpers against __proto__ and
