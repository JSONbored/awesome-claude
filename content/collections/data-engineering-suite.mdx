...
description: "A collection bundling six Claude resources for database and cloud data work: a database-specialist agent, database-expert rules, AWS services and Airtable MCP servers, plus optimize and debug commands. Aimed at SQL query tuning, database design, and connecting Claude to AWS and Airtable data sources."
