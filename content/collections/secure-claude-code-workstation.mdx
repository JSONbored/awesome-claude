...
A layered, defense-in-depth setup for an agentic Claude Code workstation. Each layer is an existing, source-backed directory entry; together they cover the main ways an agent session can leak secrets, pull untrusted code, or be steered by malicious content.
