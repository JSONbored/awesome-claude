...
category: agents
description: >-
  An agent prompt for coordinating long-running coding tasks in Claude Code for
  Web. Link a GitHub repository, dispatch async tasks that keep running after you
  close the tab, follow each agent's reasoning in the sidebar, and get a browser
  notification when the work is ready to review.
cardDescription: >-
  Coordinate long-running tasks in Claude Code for Web: link a GitHub repo,
  dispatch async sessions, and review them when notified.
seoTitle: "Claude Code for Web: Async Coding Task Coordinator"
seoDescription: >-
  Run coding tasks in Claude Code for Web: link a GitHub repo, dispatch async
  sessions that continue after you close the tab, and review on notification.
author: JSONbored
